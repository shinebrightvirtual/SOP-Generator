    ...
    <div style={{ minHeight: "100vh", background: isEmbedded ? "#EBE6E3" : colors.pageBg, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{
        background: isEmbedded
          ? "transparent"
          : `linear-gradient(180deg, ${colors.white} 0%, ${colors.pageBg} 100%)`,
        padding: isEmbedded ? "32px 24px 28px" : "52px 24px 44px",
        textAlign: "center",
      }}>
        <div style={{ maxWidth: "520px", margin: "0 auto" }}>
          ...
          <h1 style={{
            ...
            fontSize: isEmbedded ? "34px" : "42px",
            fontWeight: 700,
            color: isEmbedded ? "#803d1b" : colors.primary,
            margin: "0 0 16px",
            lineHeight: 1.15,
            letterSpacing: "-0.5px",
          }}>
      ...
      <div style={{ flex: 1, padding: "0 16px 60px", display: "flex", justifyContent: "center" }}>
        <div style={{ maxWidth: "520px", width: "100%" }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: typography.fontFamily, fontWeight: 700, fontSize: "14px", color: colors.primary, marginBottom: "5px" }}>
              ...
              <button onClick={() => setSopType("basic")} style={optCard(sopType === "basic", colors.primary)}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: "14px" }}>
                  ...
                  <button
                    ...
                    style={{ marginTop: "2px", background: "none", border: `1px solid ${colors.border}`, borderRadius: radii.md, padding: "4px 10px", fontSize: typography.sizes.caption, color: colors.textMuted, cursor: "pointer", whiteSpace: "nowrap", fontFamily: typography.fontFamily, flexShrink: 0 }}
                  >
                    See example
                  </button>
                </div>
          ...
          <div style={{
            ...
            {processing ? (
              ...
              <div style={{ marginTop: "12px", display: "flex", gap: "10px", alignItems: "center" }}>
                ...
                <input type="file" ref={txtRef} accept=".txt,.md,text/plain" style={{ display: "none" }} onChange={handleTxtUpload} />
                <button
          ...
          {!processing && (
            <>
              ...
              >
                {canManual ? "Let's do this." : "Pick a format above to keep going"}
              </button>
            </>
          )}
